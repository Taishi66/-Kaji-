# Internationalization (i18n) — Kaji Desktop UI
...
> only; the i18n infrastructure will need to be rebuilt for the new client.

This document describes the i18n infrastructure for the Kaji Desktop UI (`ui/desktop/`).
...
2. **`KAJI_LOCALE`** — explicit override from env/app config when the desktop setting is
   System Default
