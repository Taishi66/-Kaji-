# kaji Release Manual Testing Checklist
...
## Run the kaji self-test recipe

kaji run --recipe kaji-self-test.yaml

## Have kaji produce a test plan

Open the release candidate desktop app and have kaji produce a test plan by pointing it at this PR. Use a prompt like
...
kaji will produce a plan. Follow this plan to finish testing.
