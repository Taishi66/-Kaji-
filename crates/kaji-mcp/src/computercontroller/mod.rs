...
impl ComputerControllerServer {
    pub fn new() -> Self {
        ...
        // - macOS/Linux: ~/.cache/kaji/computer_controller/
        // - Windows:     ~\AppData\Local\Block\kaji\cache\computer_controller\
        ...
        Self {
            ...
            http_client: Client::builder().user_agent("kaji/1.0").build().unwrap(),
            instructions,
            system_automation,
            #[cfg(target_os = "macos")]
