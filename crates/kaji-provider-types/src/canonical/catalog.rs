...
fn synthetic_kaji_setup_entry(curated: &CuratedSetupMetadata) -> ProviderSetupCatalogEntry {
    ProviderSetupCatalogEntry {
        provider_id: curated.provider_id.to_string(),
        display_name: curated.display_name.unwrap_or("Kaji").to_string(),
        category: ProviderSetupCategory::Agent,
    ...
    SETUP_METADATA
        ...
        .filter_map(|curated| {
            if curated.synthetic {
                return Some(synthetic_kaji_setup_entry(curated));
            }
