...
pub const TOOL_META_EXTERNAL_DISPATCH_KEY: &str = "kaji.external_dispatch";
...
pub const TOOL_META_TITLE_KEY: &str = "kaji.toolSummary.title";
...
pub const TOOL_META_CHAIN_SUMMARY_KEY: &str = "kaji.toolChain.summary";
...
pub struct MessageMetadata {
    ...
    /// surfaced as `_meta.kaji.steer` so clients can mark the steer boundary
...
mod tests {
    ...
    fn test_elicitation_response_defaults_action_to_accept() {
        ...
        assert_eq!(user_data, serde_json::json!({ "name": "kaji" }));
