...
mod tests {
    ...
    mod is_openai_reasoning_model {
        ...
        const ENV_LOCK_KEYS: [(&str, Option<&str>); 5] = [
            ("KAJI_MAX_TOKENS", None),
            ("KAJI_TEMPERATURE", None),
            ("KAJI_CONTEXT_LIMIT", None),
            ("KAJI_TOOLSHIM", None),
            ("KAJI_TOOLSHIM_OLLAMA_MODEL", None),
        ];
        ...
        #[test]
        fn kaji_prefixed_reasoning_models() {
            let _guard = env_lock::lock_env(ENV_LOCK_KEYS);
            assert!(ModelConfig::new("kaji-o3-mini").is_openai_reasoning_model());
            assert!(ModelConfig::new("kaji-o4-mini").is_openai_reasoning_model());
            assert!(ModelConfig::new("kaji-gpt-5").is_openai_reasoning_model());
        }
        ...
        fn non_reasoning_models() {
            ...
            assert!(!ModelConfig::new("kaji-claude-sonnet-4").is_openai_reasoning_model());
