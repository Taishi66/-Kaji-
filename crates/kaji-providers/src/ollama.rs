...
pub struct OllamaOptions {
    /// Explicit context window override from `KAJI_INPUT_LIMIT`.
...
/// Configurable via OLLAMA_STREAM_TIMEOUT, KAJI_STREAM_TIMEOUT, or falls back
                ...
                Err(_) => {
                    Err::<(), anyhow::Error>(anyhow::anyhow!(
                        "Ollama stream stalled: no data received for {}s. \
                         ...
                         timeout via OLLAMA_STREAM_TIMEOUT, KAJI_STREAM_TIMEOUT, or \
