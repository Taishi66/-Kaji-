# Kaji SDK Maven package

This project packages the UniFFI-generated Kotlin/JVM bindings for `kaji-sdk`
as the Maven artifact `io.github.aaif-kaji:gdk`.

The artifact version is read from `crates/kaji-sdk/Cargo.toml`, so it stays in
...
```bash
just --justfile crates/kaji-sdk/justfile maven-publish
```
