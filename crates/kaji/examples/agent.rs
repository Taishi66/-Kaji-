...
use kaji::agents::{Agent, AgentEvent, ExtensionConfig, SessionConfig};
use kaji::config::{KajiMode, DEFAULT_EXTENSION_DESCRIPTION, DEFAULT_EXTENSION_TIMEOUT};
...
async fn main() -> anyhow::Result<()> {
    ...
    let model_config =
        kaji::model_config::model_config_from_user_config("databricks", DATABRICKS_DEFAULT_MODEL)?;
