...
fn build_replayed_tool_call(
    ...
    let kaji_meta = tool_call
        .meta
        .get_or_insert_default()
        .entry("kaji".to_string())
        .or_insert_with(|| serde_json::Value::Object(serde_json::Map::new()));
    if !kaji_meta.is_object() {
        *kaji_meta = serde_json::Value::Object(serde_json::Map::new());
    }
    kaji_meta
        .as_object_mut()
        .expect("kaji metadata was initialized as an object")
...
mod tests {
    ...
    fn replay_includes_persisted_enrichment_when_requested() {
        ...
        let kaji = tool_call
            ...
            .expect("valid initial tool call should contain kaji metadata");
