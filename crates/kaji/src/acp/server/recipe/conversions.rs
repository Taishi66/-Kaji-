...
use kaji_sdk_types::custom_requests::{
...
impl From<RecipeSettingsDto> for Settings {
    fn from(dto: RecipeSettingsDto) -> Self {
        Self {
            kaji_provider: dto.kaji_provider,
            kaji_model: dto.kaji_model,
...
impl From<Settings> for RecipeSettingsDto {
    fn from(settings: Settings) -> Self {
        Self {
            kaji_provider: settings.kaji_provider,
            kaji_model: settings.kaji_model,
...
) -> Result<kaji_sdk_types::custom_requests::RecipeListEntryDto> {
    Ok(kaji_sdk_types::custom_requests::RecipeListEntryDto {
        id,
    ...
    fn converts_recipe_dto_to_recipe_and_back() {
        let dto = RecipeDto {
            ...
            settings: Some(RecipeSettingsDto {
                kaji_provider: Some("openai".to_string()),
                kaji_model: Some("gpt-5".to_string()),
