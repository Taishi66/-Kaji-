...
use super::{build_session_info, KajiAcpAgent, ResultExt};
...
mod tests {
    ...
    use kaji_sdk_types::custom_requests::{ListRecipesRequest, ScheduleRecipeRequest};
    ...
    async fn disabled_scheduler_rejects_schedule_operations_without_recipe_writes() {
        ...
        let _guard = env_lock::lock_env([
            ("KAJI_DISABLE_KEYRING", Some("true")),
            ("KAJI_PATH_ROOT", root.path().to_str()),
        ]);
