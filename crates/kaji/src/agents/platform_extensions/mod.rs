...
// These are used by integration tests in crates/kaji/tests/
    ...
    || {
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                display_name: "Todo",
                description: "Enable a todo list for kaji so it can keep track of what it is doing",
                default_enabled: true,
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                display_name: "Apps",
                description:
                    "Create and manage custom Kaji apps through chat. Apps are HTML/CSS/JavaScript and run in sandboxed windows.",
                default_enabled: true,
                unprefixed_tools: false,
                hidden: false,
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                description: "Kaji will make extension calls through code execution, saving tokens",
                default_enabled: false,
                unprefixed_tools: true,
                hidden: false,
                client_factory: |ctx| {
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                description:
                    "Inject custom context into every turn via KAJI_MOIM_MESSAGE_TEXT and KAJI_MOIM_MESSAGE_FILE environment variables",
                default_enabled: true,
                unprefixed_tools: false,
                hidden: false,
...
impl PlatformExtensionContext {
    pub async fn model_config_for_session(
        &self,
        session_id: &str,
    ) -> Result<kaji_providers::model::ModelConfig, String> {
