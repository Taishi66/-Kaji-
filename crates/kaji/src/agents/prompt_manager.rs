...
impl<'a> SystemPromptBuilder<'a, PromptManager> {
    ...
    pub fn with_kaji_mode(mut self, mode: KajiMode) -> Self {
    ...
    pub fn build(self) -> String {
        ...
        let kaji_mode = self
            .kaji_mode
            .unwrap_or_else(|| Config::global().get_kaji_mode().unwrap_or_default());
        ...
        let context = SystemPromptContext {
            ...
            kaji_mode,
            is_autonomous: kaji_mode == KajiMode::Auto,
        ...
        .unwrap_or_else(|_| {
            "You are a general-purpose AI agent called kaji, created by Block".to_string()
        });
...
mod tests {
    ...
    async fn test_all_platform_extensions() {
        ...
        let _guard = env_lock::lock_env([
            ...
            ("KAJI_PATH_ROOT", Some(temp_root.as_str())),
        ]);
