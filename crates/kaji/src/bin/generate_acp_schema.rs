use kaji::acp::custom_notifications::custom_notification_schemas;
use kaji::acp::server::{agent_request_schemas, KajiAcpAgent};
...
fn main() {
    ...
    let methods = KajiAcpAgent::custom_method_schemas(&mut generator);
...
fn is_unstable_method(method: &str) -> bool {
    method.contains("_kaji/unstable")
}
