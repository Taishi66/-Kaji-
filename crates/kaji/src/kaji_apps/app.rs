...
impl KajiApp {
    ...
    const PRD_SCRIPT_TYPE: &'static str = "application/x-kaji-prd";
    const KAJI_APP_TYPE: &'static str = "KajiApp";
    const KAJI_SCHEMA_CONTEXT: &'static str = "urn:kaji.ai:schema";
    ...
    pub fn from_html(html: &str) -> Result<Self, String> {
        ...
        let json_str = metadata_re
            ...
            .ok_or_else(|| "No KajiApp JSON-LD metadata found in HTML".to_string())?
            .as_str();
    ...
    pub fn to_html(&self) -> Result<String, String> {
        ...
        let mut metadata = serde_json::json!({
            "@context": Self::KAJI_SCHEMA_CONTEXT,
            "@type": Self::KAJI_APP_TYPE,
