...
pub use persist::KajiCredentialStore;
...
const OAUTH_CALLBACK_TIMEOUT_ENV: &str = "KAJI_OAUTH_CALLBACK_TIMEOUT_SECONDS";
...
pub async fn oauth_flow(
    ...
    let credential_store = KajiCredentialStore::new(name.clone());
    ...
    let port: u16 = std::env::var("KAJI_OAUTH_CALLBACK_PORT")
        .ok()
