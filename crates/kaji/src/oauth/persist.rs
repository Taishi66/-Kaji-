...
/// Kaji-specific credential store that uses the Config system
///
/// This implementation stores OAuth credentials in the kaji configuration
/// system, which handles secure storage (e.g., keychain integration).

#[derive(Clone)]
pub struct KajiCredentialStore {
    name: String,
}

impl KajiCredentialStore {
...
impl CredentialStore for KajiCredentialStore {
