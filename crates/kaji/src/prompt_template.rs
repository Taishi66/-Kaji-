...
static TEMPLATE_REGISTRY: &[(&str, &str)] = &[
    (
        "system.md",
        "Main system prompt that defines kaji's personality and behavior",
    ),
    (
        "compaction.md",
    ...
    (
        "apps_create.md",
        "Prompt for generating new Kaji apps based on the user instructions",
    ),
    (
        "apps_iterate.md",
        "Prompt for updating existing Kaji apps based on feedback",
    ),
    (
        "permission_judge.md",
    ...
    (
        "plan.md",
        "Prompt used when kaji creates step-by-step plans. CLI only",
    ),
    (
