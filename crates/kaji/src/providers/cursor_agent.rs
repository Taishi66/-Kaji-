...
impl CursorAgentProvider {
    ...
    /// Convert kaji messages to a simple prompt format for cursor-agent CLI
    ...
    async fn execute_command(
        ...
        if std::env::var("KAJI_CURSOR_AGENT_DEBUG").is_ok() {
...
impl kaji_providers::base::ProviderDescriptor for CursorAgentProvider {
