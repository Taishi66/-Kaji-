...
use kaji_providers::api_client::TlsConfig;
use kaji_providers::base::ProviderDescriptor;
use kaji_providers::databricks::DatabricksProvider;
use kaji_providers::databricks_auth::{
...
fn resolve_instance_id() -> Option<String> {
    let enabled = Config::global()
        .get_param::<bool>("KAJI_DATABRICKS_CLIENT_REQUEST_ID")
        .unwrap_or(false);
