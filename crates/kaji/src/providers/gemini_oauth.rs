...
<html>
  <head>
    <title>kaji - Google Authorization Successful</title>
    <style>
      body {
...
<html>
  <head>
    <title>kaji - Google Authorization Failed</title>
    <style>
      body {{
        font-family: system-ui, -apple-system, sans-serif;
        display: flex;
...
impl GeminiOAuthProvider {
    ...
    async fn post_stream(
        ...
        if !response.status().is_success() {
            ...
            let text = kaji_providers::http_status::read_error_body(response)
                .await
...
impl kaji_providers::base::ProviderDescriptor for GeminiOAuthProvider {
