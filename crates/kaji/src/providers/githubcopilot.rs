...
use kaji_providers::formats::openai::is_openai_responses_model;
...
use kaji_providers::formats::openai::{create_request, get_usage, response_to_message};
use kaji_providers::formats::openai_responses::create_responses_request;
...
impl kaji_providers::base::ProviderDescriptor for GithubCopilotProvider {
    fn metadata() -> ProviderMetadata {
        ProviderMetadata::new(
            GITHUB_COPILOT_PROVIDER_NAME,
            "GitHub Copilot",
            "GitHub Copilot. Run `kaji configure` and select copilot to set up.",
