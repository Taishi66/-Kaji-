...
pub fn session_id_request_builder() -> kaji_providers::api_client::RequestBuilderDecorator {
...
/// Local OS user running kaji, shared by the OTLP `user.name` resource
...
/// Hostname of the machine running kaji, shared by the OTLP `host.name`
