...
use kaji::agents::extension_manager::{ExtensionManager, ExtensionManagerCapabilities};
...
impl kaji::providers::base::ProviderDescriptor for MockProvider {
...
async fn test_replayed_session(
    ...
    let mode = if env::var("KAJI_RECORD_MCP").is_ok() {
        TestMode::Record
    } else {
    ...
    let session_manager = Arc::new(kaji::session::SessionManager::new(
