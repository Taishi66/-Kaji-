...
use kaji::providers::api_client::{ApiClient, AuthMethod};
use kaji::providers::base::Provider;
use kaji::providers::openai::OpenAiProvider;
use kaji::session_context::{session_id_request_builder, SESSION_ID_HEADER};
...
async fn make_request(provider: &dyn Provider, session_id: &str) {
    ...
    let _ = kaji::session_context::with_session_id(
