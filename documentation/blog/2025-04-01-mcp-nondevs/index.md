...
You can also check out these [Kaji tutorials](/docs/category/mcp-servers), showing you exactly how you can use some of these popular MCP servers with Kaji, or use [Kaji's Tutorial extension](/docs/mcp/tutorial-mcp) to get extra help walking you through using or building extensions.
...
Prompts are ultimately the text you input when interacting with an AI assistant, and prompts can range from super simple questions to detailed instructions! Here are some example prompts you can ask an AI agent like Kaji right now that use some of the MCP servers mentioned above:
...
### GitHub
```
GitHub: Create a new branch called hello-world in my angiejones/kaji-demo repository. Update the README.md file to say "this was written by kaji" and commit it. Open a pull request with your changes.
```

## The Possibilities Are Endless
While some are developed by official providers, a vast majority of MCP servers you see are actually developed by community members! Plus, because MCP is an open standard, anyone can build an MCP server for any resource. You could even use Kaji to help you build one!

Hopefully now, instead of spending hours manually gathering data and creating your next marketing report, or manually sorting through your todo-backlog on a Monday, you will use MCP with Kaji and have it done for you in minutes.

*To learn more about using MCP servers and kaji, check out the [kaji documentation](https://goose-docs.ai/docs/category/getting-started), or join the [Block Open Source Discord](https://discord.gg/n8R5VaWDAn) to connect with other open source community members.*
