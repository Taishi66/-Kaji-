...
I spoke to Kaji instead of typing, using my voice as input to write code or run tasks.
...
I gave Kaji a YouTube video of a guest's conference talk. Then, I prompted Kaji to create a transcript and generate thoughtful interview questions.
...
Speaker management platforms often have different image requirements for headshots. I used to spend an embarrassingly amount of time trying to resize my photo without ruining the aspect ratio. Now, I just ask Kaji to do it.
...
I've asked Kaji to explain idioms or references that I didn't understand.  

### Why It's Useful

Because I wasn't born in America and I'm neurodivergent, I sometimes take idioms literally or misinterpret them. Instead of risking embarrassment at work, I quietly ask Kaji to translate.
...
I asked Kaji for insights about my data using natural language, and it wrote a Common Table Expression for me.

### Why It's Useful

SQL can get complex with joins, stored procedures, and subqueries. Kaji helps me move faster and avoid errors by handling the query logic for me. 
...
I've used Kaji to analyze historical conference data so I could plan smarter for upcoming CFP deadlines.

### Why It's Useful

I tend to overbook myself or get anxious that I won't get accepted, so I apply to everything. Then I end up getting accepted to all of them and say yes without thinking, which leads to poor planning and rushed talks. With Kaji, I can analyze patterns in CFP timelines and make more intentional choices.
...
A feature broke, but I had made so many commits, I couldn't tell which one introduced the bug. I asked Kaji to help me run `git bisect`, so we could identify the problematic code.

### Why It's Useful

The hardest part of debugging is often just figuring out where to look. Git bisect makes that faster, and Kaji walked me through the process without needing to memorize the steps.
...
I like to keep up with the latest technologies. Since MCP servers are popular, I used Kaji's tutorial extension to walk through building my own MCP server.

### Why It's Useful

In addition to generating code, AI agents can help you learn how to code. Kaji includes a built-in tutorial extension designed to walk users through technical concepts in a hands-on way.

### How to Try It

1. Follow [this tutorial](/docs/mcp/tutorial-mcp)
3. Prompt Kaji:
   > I'd like to learn how to build an extension or MCP server for Kaji
...
I didn't do this myself, but I was impressed to learn that a community member used Kaji to compare proposed and final versions of regulatory documents.

### Why It's Useful

Legal documents are often dense and repetitive. Kaji can highlight what actually changed, helping users quickly spot how updates impact compliance or obligations.
...
I used Kaji to build a working prototype and see the full application live in action.
...
🎥 **See it live:**  
Watch The Great Kaji Off where we challenged Kaji to create creative apps from scratch, like:  
- A Kaji-shaped drawing tool  
...
This blog post included just a few of the ways I use kaji. If you're curious about what else it can do, just ask:

What are 5 useful things you can help me with today?

Let kaji surprise you. ✨
