...
description: Learn how I use Kaji, an open source AI agent and MCP client, to manage conflicting ports without breaking my flow.
authors: 
    - rizel
---
...
I'm perpetually drowning in open tabs. Yes, I do need Bluesky, ChatGPT, Claude, Kaji, Cursor, Discord, Slack, Netflix, and Google Docs all open at the same time. I've learned that tab management isn't my only vice.
...
## Using Kaji as My Port Manager

To avoid that interruption, I started offloading the task to [Kaji](/), an open source AI agent.

Kaji uses its built-in [Developer](/docs/mcp/developer-mcp) MCP server to handle coding-related tasks on my machine. Here's what the interaction looks like:
...
- Multiple Kaji instances (ports 49377, 49899, 63594, 64365)
...
Freeing up ports is something I know how to do. But I use AI tools like Kaji for small tasks that create friction and slow me down. I'm not trying to cram more work into the day. My goal is to work efficiently, make a positive impact, and still have time for my personal life.
...
<head>
  ...
  <meta property="og:description" content="Learn how I use Kaji, an open source AI agent, to manage conflicting ports without breaking my flow." />
  ...
  <meta name="twitter:description" content="Learn how I use Kaji, an open source AI agent, to manage conflicting ports without breaking my flow." />
