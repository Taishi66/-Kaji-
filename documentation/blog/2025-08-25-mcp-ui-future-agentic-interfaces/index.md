...
In a recent [Wild Kaji Case episode](https://www.youtube.com/live/GS-kmreZDgU), we dove deep into MCP-UI with its creators Ido Salomon and Liad Yosef from Monday.com, alongside Block's own Andrew Harvard, to explore how this groundbreaking technology is reshaping the future of agentic interfaces.
...
1. **Agent Developers** (like the Kaji team): Need to implement MCP-UI support in their platforms
...
The beauty of this approach is that it creates a network effect. Once implemented, a Shopify MCP-UI component works across all compatible agents – from Kaji to VS Code extensions to future mobile AI assistants.
...
4. **Experiment with Kaji**: Try out [MCP-UI in Kaji](/docs/guides/interactive-chat/mcp-ui) to see it in action
...
*Want to see MCP-UI in action? Check out the full Wild Kaji Chase episode below and join our community to start building the future of agentic interfaces.*
