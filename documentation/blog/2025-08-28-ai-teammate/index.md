---
title: "When AI Becomes Your New Team Member: The Story of Kaji Janitor"
description: "How an engineering team is trialling autonomous AI-powered technical debt cleanup"
authors: 
    - angie
---

![blog banner](kaji-janitor.png)
...
With the serendipitous launch of Kaji recipes around the same time, the team wondered could a dedicated recipe aid this effort? [Gemma Barlow](https://www.linkedin.com/in/gemmakbarlow/), a newer iOS engineer on the team, wanted to find out. 
...
Gemma's first move was to utilize an existing system of `.mdc`, `.kajihints` and other symlinked context documents to capture how to safely remove feature flags from the repository.
...
But instead, she utilized Kaji recipes to create **Kaji Janitor**.


Kaji Janitor acts as new AI team member whose responsibility is to tidy up the code after we're done experimenting. It was heavily inspired by existing [Kaji recipes](/recipes/detail/?id=clean-up-feature-flag) and internal discussions and experimentation occurring elsewhere in Block. Here's how it is run:

```bash
kaji run \
--recipe .kaji/recipes/kaji-janitor-flag-removal.yaml \
...
Recipes like Kaji Janitor represent a fundamental shift in how we think about AI in software development. They can be deployed to:
...
Teams at Block are confident that Kaji Janitor will be of assistance in production scale cleanup work.
...
The success of Kaji Janitor opens up fascinating possibilities. What other forms of technical debt could benefit from this approach? What other "AI team members" could we build to handle routine but knowledge intensive work?
...
<head>
  <meta property="og:title" content="When AI Becomes Your New Team Member: The Story of Kaji Janitor" />
  ...
  <meta name="twitter:title" content="When AI Becomes Your New Team Member: The Story of Kaji Janitor" />
