---
title: "Automate Your Complex Workflows with Subrecipes in kaji"
description: Did you know you can call recipes from within other recipes? Learn how to orchestrate multiple AI tasks using kaji subrecipes.
authors: 
    - ian
---

![kaji Subrecipes](kaji-subrecipes.png)
...
Remember when you first learned to cook? You probably started with simple recipes like scrambled eggs or toast. But eventually you wanted to make something more complex, like a full dinner with multiple dishes. That's how subrecipes work in kaji: each recipe can run stand-alone for a dedicated task, and a main recipe can orchestrate how they run.

Let's explore [kaji subrecipes](/docs/tutorials/subrecipes-in-parallel) together! You're about to learn know how to orchestrate multiple AI models, coordinate tasks, and build workflows that will turn you into a "head chef" user with kaji.
...
That's exactly what subrecipes do for your kaji workflows. You can have one recipe that's optimized for creative tasks like image generation, another that's perfect for technical documentation, and a third that excels at writing code. Then you orchestrate them all from a main recipe.
...
settings:
  kaji_provider: "google"
  kaji_model: "gemini-2.5-flash"
  temperature: 0.5
...
kaji run --recipe 1-readme.yaml --params project_name="test" language="python" description="test project"
kaji run --recipe 2-image.yaml --params project_name="test" description="test project"  
kaji run --recipe 3-code.yaml --params project_name="test" language="python" description="test project"
```
...
Subrecipes represent something bigger than just a kaji feature. They're a glimpse into how we'll work with AI in the future -- not as monolithic systems trying to do everything, but as specialized agents working together toward common goals.
...
<head>
  <meta property="og:title" content="Automate Your Complex Workflows with Subrecipes in kaji" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://goose-docs.ai/blog/2025-09-15-subrecipes-in-goose" />
  <meta property="og:description" content="Did you know you can call recipes from within other recipes? Learn how to orchestrate multiple AI tasks using kaji subrecipes." />
  ...
  <meta name="twitter:title" content="Automate Your Complex Workflows with Subrecipes in kaji" />
  <meta name="twitter:description" content="Did you know you can call recipes from within other recipes? Learn how to orchestrate multiple AI tasks using kaji subrecipes." />
