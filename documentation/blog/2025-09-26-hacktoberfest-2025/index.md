---
title: "kaji is Celebrating Hacktoberfest 2025!"
description: Explore kaji prizes you can earn and contributions you can make during Hacktoberfest 2025
authors: 
    - tania
---
...
October is around the corner, which means spooky season is upon us, and with that crispy fall air that gives you "kaji" bumps...it's finally time for Hacktoberfest 2025! The kaji team is beyond excited to celebrate with you all for the first time this year. Let's get into how you can participate, and what prizes you can win. 👀
...
# 🎉 How Can I Contribute to kaji?
In the [kaji repo](https://github.com/aaif-goose/goose), there's something for everyone no matter if you're a newbie or a veteran.

We've created an official [kaji Hacktoberfest 2025 Project Hub](https://github.com/aaif-goose/goose/issues/4705). This hub will serve as your source of truth for all open `hacktoberfest` labeled-issues and resources you will need throughout the month. It will be updated every week with new issues as we experience contributions, so make sure to bookmark it!

From writing blog posts about kaji, fixing bugs, or adding new features, our goal is to give contributors of various practices the chance to contribute to kaji! Here are all the categories of issues you can expect to make your impact:

- Feature Requests: Add new features to improve the kaji experience
- Bug Fixes: Fix key bugs that have been troubling community members
- Platform Support: Add features and support for kaji on platforms like Windows
- Documentation: Support kaji guides with contributions to its documentation site
- Recipes: Submit your own kaji recipes for community members to bookmark & use
- Prompt Library: Submit your top prompts to kaji's library of top prompts
- Content Creation: Create blog posts and videos describing kaji and its features

# 📝 Your Guide to kaji x Hacktoberfest 2025
...
As a special thank you, the team is offering exclusive gift cards for the fresh new kaji swag shop along with free LLM credits for our Top 20 contributors:

![kaji swag shop](kajiswag.png)

| Place | Prize |
| -------- | -------- |
| 🥇 Top 1-5 Contributors | $100 gift card to kaji swag shop + $100 LLM credits     | 
| 🥈 Top 6-10 Contributors | $50 gift card to kaji swag shop + $50 LLM credits     | 
...
## When You Need Help
When in doubt, don't stress! The kaji team is here to help you make the most of your contributions. Here's where to go when you have specific questions:
...
3. 🎙️ Office Hours: Join us every Tuesday at 1pm Eastern Time on [Discord](https://discord.gg/n8R5VaWDAn) through the month of October to get live-over-voice help with open PRs, questions you may have, and general help. Keep an eye out on the [kaji events calendar](https://goose-docs.ai/community/) for future events centered around Hacktoberfest!


Happy hacking and cheers to kaji x Hacktoberfest 2025! 🎉



<head>
  <meta property="og:title" content="kaji is Celebrating Hacktoberfest 2025!" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://goose-docs.ai/blog/2025-09-26-hacktoberfest2025" />
  <meta property="og:description" content="Explore kaji prizes you can earn and contributions you can make during Hacktoberfest 2025" />
  ...
  <meta name="twitter:title" content="kaji is Celebrating Hacktoberfest 2025!" />
  <meta name="twitter:description" content="Explore kaji prizes you can earn and contributions you can make during Hacktoberfest 2025" />
