...
description: We're launching an advent calendar of AI engineering challenges to help you build applicable projects with kaji.
authors: 
    - rizel
---
...
You'll master core AI engineering skills like building gesture-controlled interfaces, data visualizations, multi-agent systems, and production deployments using kaji. These foundational skills will prepare you to work with any AI agent. Complete all 17 days, and you'll have built a comprehensive portfolio showcasing everything from basic automation to sophisticated multi-agent systems.
...
2. Install kaji using the [quickstart guide](/docs/quickstart)
...
<head>
  ...
  <meta property="og:description" content="We're launching an advent calendar of AI engineering challenges to help you build applicable projects with kaji." />
  ...
  <meta name="twitter:description" content="We're launching an advent calendar of AI engineering challenges to help you build applicable projects with kaji." />
