...
![kaji, revert this change!](header-image.png)
...
This problem has a classic engineering solution. We commit early and often to create checkpoints, enabling easy rollbacks and clean collaboration. So, why don't we enforce the same discipline on our AI agents? Here’s the workflow I use with [kaji](/) to ensure we're creating snapshots of the codebase: 
 

### 1. Set Up Version Control

I set up the [GitHub CLI](https://cli.github.com/) (`gh`). I've found Kaji interacts with it flawlessly. The [GitHub MCP Server](/docs/mcp/github-mcp) is a good alternative.
...
This is the key. I use a [`.kajihints`](/docs/guides/context-engineering/using-kajihints) or [`AGENTS.md`](/docs/guides/context-engineering/using-kajihints#custom-context-files) file with one critical instruction: 
...
Now I can prompt kaji to build, fix, or refactor. If it veers off course or makes a design choice I dislike, I can instantly review the git log or simply say: 

> *"Revert to commit abc123."*

## The Result
Then, when I'm happy with the final changes, I can push my code to remote. By integrating this basic software practice, I replace anxiety with awareness. kaji gets to be brilliantly helpful, and I get to stay in control.

Try out this method with [kaji](/) to help you build your next project. Your future self (and your git history) will thank you.
