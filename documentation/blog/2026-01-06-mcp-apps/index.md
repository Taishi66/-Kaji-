---
title: "kaji Lands MCP Apps"
description: "kaji ships early support for the draft MCP Apps specification, aligning with the emerging standard for interactive UIs in MCP."
authors:
  - aharvard
image: /img/blog/kaji-lands-mcp-apps-header-image.png
---

![Retro 1980s hardware lab with three CRT monitors displaying "kaji Lands MCP Apps" in glowing green text, with a small kaji figurine on the desk](/img/blog/kaji-lands-mcp-apps-header-image.png)

The MCP ecosystem is standardizing how servers deliver interactive UIs to hosts, and kaji is an early adopter. Today we're shipping support for the draft MCP Apps specification ([SEP-1865](https://github.com/modelcontextprotocol/ext-apps/blob/main/specification/draft/apps.mdx)), bringing kaji in line with the emerging standard, as other hosts like Claude and ChatGPT move toward adoption.
...
Extension authors can now build MCP Apps that work across kaji and any host that adopts the standard.
...
kaji has been part of this from early on. We've [shipped MCP-UI support](/blog/2025/08/11/mcp-ui-post-browser-world), participated in spec conversations, and are now implementing MCP Apps so extension authors have a real host to build against while the standard matures.
...
- **Get started:** Update kaji and point it at an MCP server that returns App resources
- **Read the spec:** [github.com/modelcontextprotocol/ext-apps](https://github.com/modelcontextprotocol/ext-apps)
- **Join the conversation:** [kaji GitHub discussion](https://github.com/aaif-goose/goose/discussions/6069) · [MCP Contributors Discord](https://discord.gg/6CSzBmMkjX)
...
<head>
  <meta property="og:title" content="kaji Lands MCP Apps" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://goose-docs.ai/blog/2026/01/06/mcp-apps" />
  <meta property="og:description" content="kaji ships early support for the draft MCP Apps specification, aligning with the emerging standard for interactive UIs in MCP." />
<meta property="og:image" content="http://goose-docs.ai/assets/images/goose-lands-mcp-apps-header-image-eb1f899d6de24f21cc2c45e46727f11d.png" />
  ...
  <meta name="twitter:title" content="kaji Lands MCP Apps" />
  <meta name="twitter:description" content="kaji ships early support for the draft MCP Apps specification, aligning with the emerging standard for interactive UIs in MCP." />
