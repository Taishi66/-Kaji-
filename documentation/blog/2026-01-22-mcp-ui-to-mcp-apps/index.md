...
As powerful as MCP-UI is, it’s still very much **host-specific**. It works beautifully inside kaji, but the question that kept sitting in the back of everyone's mind was:
...
- Let the host (like kaji) come back and fetch it separately  
...
When I first wired my Cloudinary MCP App into kaji, everything looked perfect… except the images.  
