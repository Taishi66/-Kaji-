...
description: "Using kaji with MiniMax M2.5 on the Databricks OfficeQA benchmark"
authors:
    - mic
---
...
> * Using kaji with [MiniMax M2.5](https://www.minimax.io/) on the [OfficeQA benchmark from Databricks](https://www.databricks.com/blog/officeqa), we're seeing results approaching frontier model performance for **1/30th of the cost**.
...
> * Switching to the @kaji_oss harness beat alternatives by ~10% in accuracy and was 8× cheaper than the next option. We decided to further investigate this with independent testing. On Terminal Bench 2.0, we found a similar story—kaji was 20x more token efficient (and cheaper) than OpenHands, and more than 40x cheaper than OpenCode.
...
<head>
  ...
  <meta property="og:description" content="Using kaji with MiniMax M2.5 on the Databricks OfficeQA benchmark — approaching frontier model performance at a fraction of the cost." />
</head>
