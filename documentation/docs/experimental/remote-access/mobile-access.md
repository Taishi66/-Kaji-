...
description: Mobile access via secure tunneling is no longer available in kaji Desktop.
unlisted: true
---

Mobile access via secure tunneling is no longer available in current kaji Desktop builds.
