...
Response Styles customize how tool interactions are displayed in the kaji Desktop chat window. 
...
- **Concise** (Default)
    ...
    - Shows only which tool kaji used
...
- **Detailed**
    ...
    - Best for debugging or learning how kaji works
...
When working with the kaji CLI, you can control the verbosity of tool output.
