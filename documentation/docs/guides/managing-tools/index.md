...
hide_title: true
description: Control and configure the tools and extensions that power your kaji workflows
---
...
<p className={styles.pageDescription}>
  Tools are specific functions within <a href="/docs/getting-started/using-extensions">extensions</a> that give kaji its capabilities. Learn to control and customize how these tools work for you.
</p>
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card 
      title="kaji Permissions"
      description="Choose how much autonomy kaji has when using tools, editing files, and taking action in a session."
      link="/docs/guides/managing-tools/kaji-permissions"
    />
    <Card 
      title="Tool Permissions"
      description="Configure fine-grained permissions to control which tools kaji can use and when, ensuring secure and controlled automation."
