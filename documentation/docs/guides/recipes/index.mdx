...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Complete technical reference for creating and customizing recipes in kaji via the CLI."
    ...
    />
    <Card 
      title="kaji Recipes Tutorial"
      description="Learn how to create and use kaji recipes with prompts, parameters, MCP servers, and more."
    ...
    <Card 
      ...
      description="Learn how to save, organize, and find your kaji recipes for easy access and reuse."
...
<VideoCarousel
  ...
  videos={[
    { 
      ...
      title: 'Advanced Tips for Recipes/Subrecipes in kaji',
      description: 'Advanced tips for using recipes and subrecipes in kaji',
      duration: '10:07'
    },
    { 
      type: 'iframe', 
      src: 'https://youtube.com/embed/gvg7DomaJuA',
      title: 'Headless kaji, Scheduling a Parallel-Subagent Recipe',
