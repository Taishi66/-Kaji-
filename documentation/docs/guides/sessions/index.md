...
hide_title: true
description: Manage your session lifecycle and ongoing interactions with kaji
---
...
<p className={styles.pageDescription}>
  Sessions are your continuous interactions with kaji. Each session maintains context and conversation history, enabling kaji to understand your ongoing work and provide relevant assistance.
</p>
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Discover features you can use to share information and communicate with kaji during sessions."
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card
      ...
      link="/blog/2025/03/06/kaji-tips"
    />
    <Card
    ...
    <Card
      ...
      description="Learn how context windows, tokens, and kaji help you manage memory and long conversations."
