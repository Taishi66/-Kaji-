...
description: Add {Extension Name} MCP Server as a kaji Extension
---
...
This tutorial covers how to add the [{Extension Name} MCP Server](/) as a kaji extension to enable ________________.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="kaji Desktop" default>
  [Launch the installer]({kaji_url})
  </TabItem>
