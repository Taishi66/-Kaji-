...
description: Add Cash App as a kaji Extension
---
...
<Tabs groupId="interface">
  ...
  [Install Cash App extension](kaji://extension?type=streamable_http&url=https%3A%2F%2Fconnect.squareup.com%2Fv2%2Fmcp%2Fcash-app&id=cash-app&name=Cash%20App&description=Cash%20App%20brings%20local%20food%20ordering%20into%20the%20AI%20era.)
  </TabItem>
...
Get a full menu overview with categories, prices, descriptions, and recommended items — all in plain text that kaji can reason about.
...
Because the menu comes back as structured text, kaji can answer follow-up questions like *"which items are under $10?"* or *"what's vegetarian?"* without another tool call.

### Build a Cart and Check Out

Once you've found what you want, tell kaji to build your order. It handles item selection, modifiers, and quantities — then gives you a checkout link to complete payment through Cash App.
...
Cash App is most powerful when kaji combines it with your other tools and the context of your day:
