...
description: Use Computer Controller MCP Server as a kaji Extension
---
...
This tutorial covers enabling and using the Computer Controller MCP Server, which is a built-in kaji extension.

:::tip
Let kaji complete its tasks without interruption - avoid using your mouse or keyboard until it's done.
:::
...
In this example, I'll show you how kaji can multitask, handling everything from system controls and music playback to web research and data organization.
...
### kaji Prompt
```
kaji, I need to decompress while researching AI models for tomorrow's meeting. Can you create a relaxing environment and help me research?
