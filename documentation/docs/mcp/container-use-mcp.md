...
description: Use Container-Use MCP as a kaji Extension
---
...
This tutorial covers how to add the [Container Use MCP Server](https://container-use.com) as a kaji extension enabling kaji to work in an isolated environment.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="kaji Desktop" default>
  [Launch the installer](kaji://extension?cmd=container-use&arg=stdio&id=container-use&name=container%20use&description=use%20containers%20with%20dagger%20and%20git%20for%20isolated%20environments)
  </TabItem>
