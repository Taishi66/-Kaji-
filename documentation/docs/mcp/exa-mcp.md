...
description: Add Exa MCP Server as a kaji Extension
---
...
This tutorial covers how to add the [Exa MCP Server](https://github.com/exa-labs/exa-mcp-server) as a kaji extension to enable AI-powered web search functionality.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="kaji Desktop" default>
  [Launch the installer](kaji://extension?cmd=npx&arg=-y&arg=exa-mcp-server&id=exa&name=Exa%20Search&description=AI-powered%20web%20search&env=EXA_API_KEY%3DExa%20API%20Key)
  </TabItem>
...
The Exa MCP server enables AI-powered web search in your kaji interactions. Exa offers advanced search capabilities including:
