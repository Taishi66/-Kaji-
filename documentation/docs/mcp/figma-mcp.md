...
description: Add Figma Dev Mode MCP Server as a kaji Extension
---
...
This tutorial covers how to add the [Figma Dev Mode MCP Server](https://help.figma.com/hc/en-us/articles/32132100833559-Guide-to-the-Dev-Mode-MCP-Server) as a kaji extension to enable interaction with Figma files, designs, and components.
...
<Tabs groupId="interface">
  <TabItem value="ui" label="kaji Desktop" default>
    [Launch the installer](kaji://extension?type=streamable_http&url=http%3A%2F%2F127.0.0.1%3A3845%2Fmcp&id=figma&name=Figma&description=Convert%20Figma%20designs%20into%20code%20and%20extract%20design%20context)
  </TabItem>
  <TabItem value="cli" label="kaji CLI">
    Use `kaji configure` to add a `Remote Extension (Streamable HTTP)` extension type with:
...
2. Add the Figma extension to kaji:
   <Tabs groupId="interface">
     <TabItem value="ui" label="kaji Desktop" default>
...
The Figma extension in kaji works alongside the Figma desktop app. You can use the extension to:
...
:::tip
You can provide kaji with a Figma link or simply select an element in the Figma desktop app.
:::
...
- **Image Asset**: The kaji logo is loaded from a localhost server as a background image  
- **Typography**: Uses Inter Black font for the "ask kaji" text
...
- **Logo**: kaji silhouette image positioned on the left side
- **Text**: "ask kaji" text positioned on the right in dark gray (#333b43)
