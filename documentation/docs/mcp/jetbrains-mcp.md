...
description: Use JetBrains MCP Server as a kaji Extension
---
...
This tutorial covers how to add the JetBrains extension to integrate with any JetBrains IDE. While kaji can use the [Developer extension](/docs/mcp/developer-mcp) for developer-centric tasks, the JetBrains extension provides a more integrated and project-aware way to work with code.
...
<Tabs groupId="ideVersion">
  <TabItem value="2026.1" label="2026.1 and later" default>
    ...
    <Tabs groupId="interface">
      ...
      Use `kaji configure` with the URL from `Copy HTTP Stream Config` in your IDE.
      </TabItem>
    </Tabs>
    :::
    ...
    2. Add the JetBrains extension to kaji using the URL from the config:
       ...
       <Tabs groupId="interface">
         <TabItem value="ui" label="kaji Desktop" default>
           ...
           4. On the `Add custom extension` modal, enter the following:
              ...
              - **Description**: Integrate kaji with any JetBrains IDE
  ...
  <TabItem value="2025.2" label="2025.2 – 2025.x">
    ...
    <Tabs groupId="interface">
      ...
      <TabItem value="cli" label="kaji CLI">
      Use `kaji configure` with the command from `Copy Stdio Config` in your IDE.
      </TabItem>
    </Tabs>
    :::
    ...
    2. Add the JetBrains extension to kaji using the command from the config:
...
<Tabs groupId="interface">
  <TabItem value="ui" label="kaji Desktop" default>
   ...
   2. Open a new session in kaji Desktop
   :::note
   You will interact with two separate apps: the kaji Desktop app and the IntelliJ IDE.
   :::
  ...
  1. Open [IntelliJ](https://www.jetbrains.com/idea/download) (JetBrains' Java and Kotlin IDE)
  2. Open a terminal within your IDE and start a new kaji session:
...
:::tip
When using kaji to refactor code, it's recommended to commit your code to version control _before_ making changes. This way, you have a clean snapshot to compare against, making it easy to review kaji's modifications, revert if needed, and track improvements.
:::
...
After 2 minutes, kaji was done with the upgrade! 🎉
...
Using the JetBrains extension provided several advantages and made it easier for kaji to:
