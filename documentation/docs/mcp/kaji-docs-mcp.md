---
title: kaji Docs Extension

description: Add kaji Docs MCP Server as a kaji Extension
---
...
This tutorial covers how to add the [kaji Docs MCP Server](https://github.com/idosal/git-mcp) as a kaji extension to enable kaji to answer questions about itself.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="kaji Desktop" default>
  [Launch the installer](kaji://extension?cmd=npx&arg=mcp-remote&arg=https%3A%2F%2Fblock.gitmcp.io%2Fkaji%2F&id=kaji-docs&name=kaji%20Docs&description=gitmcp%20for%20kaji%20documentation)
  </TabItem>
...
<Tabs groupId="interface">
  <TabItem value="ui" label="kaji Desktop" default>
    <KajiDesktopInstaller
      extensionId="kaji-docs"
      extensionName="kaji Docs"
      description="GitMCP for kaji documentation"
      command="npx"
...
## Example Usage
GitMCP allows you to convert any Git repository into a kaji extension. The kaji Docs MCP Server is a great example of this, as it provides a way for kaji to answer questions about itself.

Let's ask kaji to create a recipe for us! It will use the kaji Docs MCP Server to find the relevant information.


### kaji Prompt

```
hey kaji, I want to create a recipe for automated code review that my development team can use. Can you look at the kaji documentation to understand the recipe format, then create a recipe that:
...
Please research the recipe format first using the kaji Docs extension, then create a complete recipe file with proper YAML structure, parameters, and any needed extensions. 
...
Perfect! I've created a comprehensive automated code review recipe based on the kaji documentation research. Here's what I've built for your development team:
...
#### Basic Usage:
```bash
kaji run automated-code-review.yaml \
...
- Proper YAML structure following kaji recipe format
    ...
    properties:
      ...
      ci_cd_metadata:
        ...
        properties:
          ...
          reviewer:
            type: string
            description: "kaji automated code review"
          language:
            type: string
