...
description: Add Nano Banana MCP Server as a kaji Extension
---
...
This tutorial covers how to add the [Nano Banana MCP Server](https://github.com/ConechoAI/Nano-Banana-MCP) as a kaji extension that provides AI image generation and editing capabilities using Google's Gemini Image API.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="kaji Desktop" default>
  [Launch the installer](kaji://extension?cmd=npx&arg=nano-banana-mcp&id=nano-banana-mcp&name=Nano%20Banana&description=Image%20generation%20with%20Gemini)
  </TabItem>
...
With Nano Banana, you can generate new images and edit existing images in natural language.  Simply describe what you want created or modified and kaji will turn that into a detailed prompt to provide to Nano Banana.
