...
description: Add Netlify MCP Server as a kaji Extension
---
...
This tutorial covers how to add the [Netlify MCP Server](https://github.com/netlify/netlify-mcp) as a kaji extension to build, deploy, and manage Netlify sites.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="kaji Desktop" default>
  [Launch the installer](kaji://extension?cmd=npx&arg=-y&arg=%40netlify%2Fmcp&id=netlify-mcp&name=Netlify&description=Build%2C%20deploy%2C%20and%20manage%20sites%20with%20Netlify%27s%20official%20MCP%20server.)
  </TabItem>
...
In this example, I’ll show you how to use kaji with the Netlify Extension to deploy a web application.
