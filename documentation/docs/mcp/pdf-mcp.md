...
description: Add PDF Reader MCP Server as a kaji Extension
---
...
This tutorial covers how to add the [PDF Reader MCP Server](https://github.com/michaelneale/mcp-read-pdf) as a kaji extension, enabling kaji to read and extract text from protected and unprotected PDFs.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="kaji Desktop" default>
  [Launch the installer](kaji://extension?cmd=uvx&arg=mcp-read-pdf&id=pdf_read&name=PDF%20Reader&description=Read%20large%20and%20complex%20PDF%20documents)
  </TabItem>
...
This example shows how to use the PDF Reader Extension to analyze an applicant's resume for specific attributes. With the PDF Reader extension, kaji can read specific pages or entire documents as well as extract text from large and complex PDFs.
