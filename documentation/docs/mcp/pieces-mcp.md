...
description: Add Pieces for Developers MCP Server as a kaji Extension
---
...
This tutorial covers how to add the [Pieces for Developers MCP Server](https://docs.pieces.app/products/mcp/get-started?utm_source=goose&utm_medium=collab&utm_campaign=mcp) as a kaji extension to enable interaction with your Pieces Long-Term Memory.
...
1. Code Development with kaji:

    Activity: You worked on integrating MCP servers into the kaji CLI, making enhancements to handle extensions via schema URLs.
    Description: This task involved modifying code and testing new integrations to support advanced functionalities. It also included interactions with the kaji community on Discord for feedback and troubleshooting.

2. Documentation Updates:

    Activity: You updated and managed documentation related to the kaji project and MCP integrations.
...
4. Managing and Testing Extensions:
    ...
    Activity: You focused on testing and managing various extensions through the kaji platform.
