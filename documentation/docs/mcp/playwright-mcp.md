...
description: Add Playwright MCP Server as a kaji Extension for Modern Web Testing
---
...
This tutorial covers how to add the Playwright MCP Server as a kaji extension, to enable cross-browser testing and web automation across Chromium and Webkit.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="kaji Desktop" default>
  [Launch the installer](kaji://extension?cmd=npx&arg=-y&arg=@playwright/mcp@latest&id=playwright&name=Playwright&description=Modern%20web%20testing%20and%20automation)
  </TabItem>
...
Let's use kaji with the Playwright extension to create a cross-browser testing suite. In this example, we'll demonstrate how kaji can help you:
