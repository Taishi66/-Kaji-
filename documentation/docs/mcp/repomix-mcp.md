...
description: Add Repomix MCP Server as a kaji Extension
---
...
<Tabs groupId="interface">
  ...
  <KajiDesktopInstaller
    ...
    description="Pack repositories into AI-friendly formats for kaji"
    command="npx"
    args={["-y", "repomix", "--mcp"]}
  />
</TabItem>
...
In this example, I’ll show you how to use kaji with the Repomix Extension to analyze the compressed Axios repository. kaji will focus on the `lib/core/Axios.js` file, explain its role in the architecture, spot missing tests, write new unit tests, and suggest improvements to the testing strategy and code maintainability. 

By compressing the entire codebase into an AI-friendly format, Repomix helps kaji stay within token limits while providing detailed, file-specific insights.
