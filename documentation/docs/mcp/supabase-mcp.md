...
description: Add Supabase MCP Server as a kaji Extension
---
...
When you first connect to the Supabase MCP Server through kaji, an OAuth window will open in your browser. Follow the prompts to authorize access to your Supabase projects.
...
Deploy and manage Supabase Edge Functions directly through kaji.
