...
description: Add vmware-aiops MCP Server as a kaji Extension for natural language VMware vCenter/ESXi operations
---
...
This tutorial covers how to add [vmware-aiops](https://github.com/zw008/VMware-AIops) as a kaji extension, enabling natural language management of VMware vCenter and ESXi infrastructure. With this extension, kaji can list VMs, check health, power on/off machines, deploy from templates, run commands inside VMs, and orchestrate multi-step operations with automatic rollback.
...
<Tabs groupId="interface">
  <TabItem value="ui" label="kaji Desktop" default>
    ...
    vmware-aiops mcp-config install --agent kaji
    ```
  </TabItem>
...
In this example, I'll use kaji to perform a daily health check across my vCenter environment and remediate a disk space issue on a VM — all via natural language.
