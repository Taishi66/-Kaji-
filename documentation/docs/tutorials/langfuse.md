---
description: Integrate kaji with Langfuse to observe performance
---

# Observability with Langfuse

This tutorial covers how to integrate kaji with Langfuse to monitor your kaji requests and understand how the agent is performing.
...
## Configure kaji to Connect to Langfuse

Set the environment variables so that kaji (written in Rust) can connect to the Langfuse server.
...
## Run kaji with Langfuse Integration

Now, you can run kaji and monitor your AI requests and actions through Langfuse.

With kaji running and the environment variables set, Langfuse will start capturing traces of your kaji activities.
...
![kaji trace in Langfuse](https://langfuse.com//images/docs/goose-integration/goose-example-trace.png)
