...
export default function CLIExtensionInstructions({
  ...
  return (
    <div>
      ...
      <CodeBlock language="sh">{`kaji configure`}</CodeBlock>
      ...
      <CodeBlock language="sh">{`┌   kaji-configure
│
...
└`}</CodeBlock>
      ...
      <ol start={5}>
        <li>
          Enter the number of seconds kaji should wait for actions to complete before timing out. Default is{' '}
