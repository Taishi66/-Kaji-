...
interface KajiDesktopInstallerProps {
  extensionId: string;
...
export default function KajiDesktopInstaller({
  extensionId,
  extensionName,
  description,
  type,
  ...
  const buildKajiUrl = () => {
    ...
    return `kaji://extension?${urlParts.join('&')}`;
  };
  ...
  return (
    <div>
      <ol>
        <li>
          <a href={buildKajiUrl()}>Launch the installer</a>
        </li>
