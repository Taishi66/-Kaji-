...
# ///
"""Harbor benchmark runner and reporter for Kaji.
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_run.add_argument("kaji_binary", type=Path, help="path to the kaji binary to test")
    ...
    p_run.add_argument(
        "--no-install-kaji-runtime-deps",
        dest="install_kaji_runtime_deps",
        action="store_false",
        default=True,
    ...
    p_pull.add_argument(
        "remote",
        help="user@host:/path/to/kaji (we append evals/harbor/runs/)",
    )
    p_pull.add_argument(
        "--jobs",
        nargs="*",
