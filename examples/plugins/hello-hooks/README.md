...
A tiny [Open Plugins](https://open-plugins.com) plugin that demonstrates kaji's
...
Kaji discovers plugins under `~/.agents/plugins/<name>/` (user scope) and
...
# Then run kaji normally; you should see lines like
