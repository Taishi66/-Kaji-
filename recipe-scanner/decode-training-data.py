...
def write_training_files(training_data, output_dir="/tmp/training"):
    """
    Write decoded training files to disk for Kaji to analyze
    """
    output_path = Path(output_dir)
    output_path.mkdir(exist_ok=True)
    
    # Write a summary file for Kaji
    summary = {
...
def create_kaji_instructions(training_data, output_file="/tmp/kaji_training_instructions.md"):
    """
    Create instructions for Kaji based on the training data
    """
    instructions = [
    ...
    print(f"📋 Kaji instructions written to: {output_file}")
    return output_file
...
if __name__ == "__main__":
    ...
    if training_data:
        ...
        instructions_file = create_kaji_instructions(training_data)
