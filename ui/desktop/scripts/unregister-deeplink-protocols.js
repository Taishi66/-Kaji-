...
/**
 * Script to unregister ALL kaji:// protocol handlers
...
function unregisterAllProtocolHandlers() {
  console.log('Unregistering ALL kaji:// protocol handlers...');
  
  try {
    // Get all registered Kaji apps
    console.log('Finding all registered Kaji applications...');
    ...
    if (pathMatches) {
      pathMatches.forEach(match => {
        ...
        if (path.includes('Kaji') || path.includes('kaji')) {
          uniquePaths.add(path);
        }
      });
    }
    
    console.log(`Found ${uniquePaths.size} Kaji app(s) to unregister:`);
    ...
    console.log(`\n✅ Successfully processed ${unregisteredCount} Kaji applications`);
    console.log('All kaji:// protocol handlers have been unregistered.');
    ...
    console.log('1. Use Activity Monitor to quit all Kaji processes');
    console.log('2. Delete Kaji apps from Applications folder');
