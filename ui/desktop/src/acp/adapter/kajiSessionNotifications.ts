...
export function applyKajiSessionNotification(
  state: AdapterState,
...
function applyStatusMessage(
  state: AdapterState,
  sessionId: string,
  update: Extract<KajiSessionNotification_unstable['update'], { sessionUpdate: 'status_message' }>
): AcpChatStateChange[] {
...
function applyMessageUsage(
  state: AdapterState,
  update: Extract<KajiSessionNotification_unstable['update'], { sessionUpdate: 'message_usage' }>
): AcpChatStateChange[] {
