...
export async function acpListProviderDetails(): Promise<ProviderDetails[]> {
  ...
  const { entries } = await client.kaji.providersList_unstable({});
...
export async function acpListProviderModels(providerId: string) {
  const client = await getAcpClient();
  const { entries } = await client.kaji.providersList_unstable({ providerIds: [providerId] });
...
export async function acpListProviderCatalogEntries(
  ...
  const client = await getAcpClient();
  const { providers } = await client.kaji.providersCatalogList_unstable(format ? { format } : {});
  return providers;
}

export async function acpGetProviderTemplate(providerId: string): Promise<ProviderTemplateDto> {
  const client = await getAcpClient();
  const { template } = await client.kaji.providersCatalogTemplate_unstable({ providerId });
  return template;
}
...
export async function acpGetCustomProvider(
  ...
  const client = await getAcpClient();
  return client.kaji.providersCustomRead_unstable({ providerId });
}
...
export async function acpCreateCustomProviderFromRequest(
  ...
  const client = await getAcpClient();
  const response = await client.kaji.providersCustomCreate_unstable(
...
export async function acpUpdateCustomProviderFromRequest(
  ...
  const client = await getAcpClient();
  await client.kaji.providersCustomUpdate_unstable({
    providerId,
    ...updateRequestToCreate(request),
  });
}
...
export async function acpDeleteCustomProvider(providerId: string): Promise<void> {
  const client = await getAcpClient();
  await client.kaji.providersCustomDelete_unstable({ providerId });
}

export async function acpReadProviderConfig(providerId: string) {
  const client = await getAcpClient();
  const { fields } = await client.kaji.providersConfigRead_unstable({ providerId });
  return fields;
}

export async function acpDeleteProviderConfig(providerId: string): Promise<void> {
  const client = await getAcpClient();
  await client.kaji.providersConfigDelete_unstable({ providerId });
}
...
export async function acpSaveProviderConfig(
  ...
  const client = await getAcpClient();
  await client.kaji.providersConfigSave_unstable({ providerId, fields });
}

export async function acpAuthenticateProvider(providerId: string): Promise<void> {
  const client = await getAcpClient();
  await client.kaji.providersConfigAuthenticate_unstable({ providerId });
}

export async function acpListProviderSecrets(): Promise<ProviderSecretDto[]> {
  const client = await getAcpClient();
  const { secrets } = await client.kaji.providersSecretsList_unstable({});
  return secrets;
}

export async function acpDeleteProviderSecret(id: string): Promise<void> {
  const client = await getAcpClient();
  await client.kaji.providersSecretsDelete_unstable({ id });
}
...
export async function acpGetCanonicalModelInfo(
  ...
  const client = await getAcpClient();
  const { modelInfo } = await client.kaji.providersCanonicalModelInfo_unstable({
    provider,
    model,
  });
...
export async function acpReadDefaults(): Promise<{
  ...
  const client = await getAcpClient();
  const response = await client.kaji.defaultsRead_unstable({});
  return {
...
export async function acpSaveDefaults(providerId: string, modelId?: string | null): Promise<void> {
  const client = await getAcpClient();
  await client.kaji.defaultsSave_unstable({ providerId, modelId: modelId ?? null });
}

export async function acpClearDefaults(): Promise<void> {
  const client = await getAcpClient();
  await client.kaji.defaultsClear_unstable({});
}

export async function acpReadThinkingEffort(): Promise<ThinkingEffort | null> {
  const client = await getAcpClient();
  const response = await client.kaji.preferencesRead_unstable({ keys: ['kajiThinkingEffort'] });
  const value = response.values.find((v) => v.key === 'kajiThinkingEffort')?.value;
...
export async function acpSaveThinkingEffort(effort: ThinkingEffort): Promise<void> {
  const client = await getAcpClient();
  await client.kaji.preferencesSave_unstable({
    values: [{ key: 'kajiThinkingEffort', value: effort }],
  });
}
