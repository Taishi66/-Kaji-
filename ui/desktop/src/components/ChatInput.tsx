...
export default function ChatInput({
  ...
  useEffect(() => {
    try {
      window.sessionStorage.setItem('kaji-queue-paused', JSON.stringify(queuePausedRef.current));
    } catch (error) {
  ...
  useEffect(() => {
    try {
      window.sessionStorage.setItem('kaji-queue-interruption', JSON.stringify(lastInterruption));
    } catch (error) {
