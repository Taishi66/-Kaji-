...
const i18n = defineMessages({
  ...
  defaultMessage: {
    ...
    defaultMessage: 'Kaji needs some information from you.',
  },
  submit: {
...
export default function ElicitationRequest({
  ...
  if (isCancelledMessage) {
    return (
      <div className="kaji-message-content bg-background-secondary rounded-2xl px-4 py-2 text-text-primary">
  ...
  return (
    <div className="flex flex-col">
      <div className="kaji-message-content bg-background-secondary rounded-2xl rounded-b-none px-4 py-2 text-text-primary">
        <div className="flex justify-between items-start gap-4">
          <span>{message || intl.formatMessage(i18n.defaultMessage)}</span>
        </div>
      </div>
      <div className="kaji-message-content bg-background-primary border border-border-primary dark:border-gray-700 rounded-b-2xl px-4 py-3">
        {hasSchemaFields ? (
          <JsonSchemaForm
            schema={schema}
