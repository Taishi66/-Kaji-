...
import type { KajiDisplayMode, OnDisplayModeChange } from './types';
...
interface UseDisplayModeOptions {
  displayMode: KajiDisplayMode;
  onDisplayModeChange?: OnDisplayModeChange;
  containerRef: React.RefObject<HTMLDivElement | null>;
}

export interface DisplayModeState {
  activeDisplayMode: KajiDisplayMode;
  ...
  changeDisplayMode: (mode: KajiDisplayMode) => void;
...
export function useDisplayMode({
  ...
  const [activeDisplayMode, setActiveDisplayMode] = useState<KajiDisplayMode>(displayMode);
