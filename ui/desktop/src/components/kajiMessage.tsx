...
export default function KajiMessage({
  sessionId,
  message,
  messages,
  ...
  return (
    <div className="kaji-message flex w-[90%] justify-start min-w-0">
            ...
            <div className="relative flex flex-col w-full group">
              <div className="flex flex-col gap-3">
                {toolRequests.map((toolRequest) => {
                  ...
                  return (
                    <div className="kaji-message-tool" key={toolRequest.id}>
