...
const i18n = defineMessages({
  ...
  deeplinkPlaceholder: {
    ...
    defaultMessage: 'Paste your kaji://recipe?config=... deeplink here',
  },
  deeplinkHint: {
    id: 'importRecipeForm.deeplinkHint',
    defaultMessage: 'Paste a recipe deeplink starting with "kaji://recipe?config="',
  },
  or: {
  ...
  reviewWarning: {
    ...
    defaultMessage: 'Ensure you review contents of recipe files before adding them to your kaji interface.',
  },
  cancel: {
...
const importRecipeSchema = z
  .object({
    deeplink: z
      .string()
      .refine(
        (value) => !value || value.trim().startsWith('kaji://recipe?config='),
        'Invalid deeplink format. Expected: kaji://recipe?config=...'
      ),
    recipeUploadFile: z
      .instanceof(File)
      .nullable()
