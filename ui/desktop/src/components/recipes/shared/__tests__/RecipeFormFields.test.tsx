    ...
    it('pre-fills subrecipes from initial values', async () => {
      ...
      const initialValues: Partial<RecipeFormData> = {
        subRecipes: [
          {
            name: 'data_fetcher',
            path: '~/.config/kaji/recipes/abc123.yaml',
      ...
      expect(screen.getByText('~/.config/kaji/recipes/abc123.yaml')).toBeInTheDocument();
        ...
        subRecipes: [
          {
            ...
            path: '~/.config/kaji/recipes/def456.yaml',
            sequential_when_repeated: false,
        ...
        subRecipes: [
          {
            ...
            path: '~/.config/kaji/recipes/ghi789.yaml',
    ...
    it('removes a subrecipe when its delete button is clicked', async () => {
      ...
      const initialValues: Partial<RecipeFormData> = {
        subRecipes: [
          {
            name: 'to_be_deleted',
            path: '~/.config/kaji/recipes/jkl012.yaml',
            sequential_when_repeated: false,
          },
        ],
      };
