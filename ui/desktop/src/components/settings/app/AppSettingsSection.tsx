...
import ThemeSelector from '../../KajiSidebar/ThemeSelector';
...
const i18n = defineMessages({
  ...
  appearanceDesc: {
    ...
    defaultMessage: 'Configure how kaji appears on your system',
  },
  ...
  taskNotificationsDesc: {
    ...
    defaultMessage: 'Notify when Kaji finishes a task while the window is in the background',
  },
  menuBarIcon: { id: 'settings.menuBarIcon.title', defaultMessage: 'Menu bar icon' },
  menuBarIconDesc: {
    id: 'settings.menuBarIcon.description',
    defaultMessage: 'Show kaji in the menu bar',
  },
  dockIcon: { id: 'settings.dockIcon.title', defaultMessage: 'Dock icon' },
  dockIconDesc: { id: 'settings.dockIcon.description', defaultMessage: 'Show kaji in the dock' },
  preventSleep: { id: 'settings.preventSleep.title', defaultMessage: 'Prevent Sleep' },
  preventSleepDesc: {
    id: 'settings.preventSleep.description',
    defaultMessage:
      'Keep your computer awake while kaji is running a task (screen can still lock)',
  },
  ...
  themeDesc: {
    ...
    defaultMessage: 'Customize the look and feel of kaji',
  },
  languageTitle: { id: 'settings.language.title', defaultMessage: 'Language' },
  languageDesc: {
    id: 'settings.language.description',
    defaultMessage: 'Choose the display language for kaji',
  },
  ...
  helpDesc: {
    ...
    defaultMessage: 'Help us improve kaji by reporting issues or requesting new features',
  },
  ...
  updatesDesc: {
    ...
    defaultMessage: 'Check for and install updates to keep kaji running at its best',
  },
  ...
  notificationsMacStep3: {
    ...
    defaultMessage: 'Find and select kaji in the application list',
  },
...
export default function AppSettingsSection({ scrollToSection }: AppSettingsSectionProps) {
  ...
  const shouldShowUpdates = !window.appConfig.get('KAJI_VERSION');
  ...
  return (
    <div className="space-y-4 pr-4 pb-8 mt-1">
      ...
      {/* Version Section - only show if KAJI_VERSION is set */}
      {!shouldShowUpdates && (
        <Card className="rounded-lg">
          <CardHeader className="pb-0">
          ...
          <CardContent className="pt-4 px-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-mono text-black dark:text-white">
                {String(window.appConfig.get('KAJI_VERSION') || 'Development')}
              </span>
            </div>
          </CardContent>
        </Card>
      ...
      {/* Update Section - only show if KAJI_VERSION is NOT set */}
