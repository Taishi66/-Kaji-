...
const i18n = defineMessages({
  ...
  focusWindowLabel: {
    ...
    defaultMessage: 'Focus Kaji Window',
  },
  focusWindowDescription: {
    id: 'keyboardShortcuts.focusWindowDescription',
    defaultMessage: 'Bring Kaji window to front from anywhere',
  },
  quickLauncherLabel: {
  ...
  newChatWindowDescription: {
    ...
    defaultMessage: 'Open a new Kaji window',
  },
  openDirectoryLabel: {
  ...
  categoryGlobalDescription: {
    ...
    defaultMessage: 'These shortcuts work system-wide, even when Kaji is not focused',
  },
  categoryApplication: {
  ...
  categoryApplicationDescription: {
    ...
    defaultMessage: 'These shortcuts work when Kaji is the active application',
  },
  categorySearch: {
  ...
  restartDescription: {
    ...
    defaultMessage:
      'Changes to application shortcuts (like New Chat, Settings, etc.) require restarting Kaji to take effect. Global shortcuts (Focus Window, Quick Launcher) work immediately.',
  },
  dismiss: {
