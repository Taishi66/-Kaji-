...
export class KajiClient {
  private conn: ClientSideConnection;
  private ext: KajiExtClient;

  constructor(
    toClient: () => KajiClientCallbacks,
    ...
    const toAcpClient = () =>
      installKajiExtAgentRequestDispatcher(
        installKajiExtNotificationDispatcher(toClient()),
      );
    this.conn = new ClientSideConnection(toAcpClient, stream);
    this.ext = new KajiExtClient(this.conn);
  }
